...
object PrefsHelper {
    ...
    private val FIRST_CONNECT = "first_connect"
    private val APPS_NOT_USING = "not_allowed_apps"
    private val CONNECT_SERVER_ID = "connect_server_id"
    private val ORIGINAL_IP = "original_ip"
    private val ADS_INITIALIZED = "setup"
    private val SAVED_USERNAME_KEY = "save_auth_username"
    private val SAVED_PASSWORD_KEY = "save_auth_password"

    private val ADMOB_BANNER_ID = "admob_banner_id"
    private val ADMOB_INTER_ID = "admob_inter_id"
    private val ADMOB_REWARDED_ID = "admob_rewarded_id"
    private val ADMOB_REWARDED_INTER_ID = "admob_rewarded_inter_id"
    private val ADMOB_NATIVE_ID = "admob_native_id"
    private val ADMOB_APP_OPEN_ID = "admob_app_open_id"
